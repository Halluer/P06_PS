...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_DESCRIPTION2 = "noteContent2";
    ...
    public void insertNote(String noteContent, String noteContent2) {
        ...
        values.put(COLUMN_DESCRIPTION2, noteContent2);
